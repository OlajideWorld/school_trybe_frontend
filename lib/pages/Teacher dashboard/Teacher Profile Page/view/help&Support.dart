...
class TeacherHelpAndSupportScreen extends StatelessWidget {
  const TeacherHelpAndSupportScreen({super.key});
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(children: [
          GestureDetector(
            onTap: () {
              Get.to(() => TeacherSendAnIssueScreen());
            },
            child: const TeacherHelpAndSupportWidget(
                image: "assets/Teacher_Dash/support1.png",
                text: "Contact customer support"),
          ),
          SizedBox(height: heightSize(20)),
          const TeacherHelpAndSupportWidget(
