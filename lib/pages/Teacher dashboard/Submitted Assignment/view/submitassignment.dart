...
import "package:school_management/pages/Teacher%20dashboard/Submitted%20Assignment/view/selectsection.dart";
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          GestureDetector(
            onTap: () {
              Get.to(() => const SelectSectionSubmit());
            },
          ...
          SizedBox(height: heightSize(10)),
          selectClassOptions(context, "Jss Three"),
          SizedBox(height: heightSize(10)),
