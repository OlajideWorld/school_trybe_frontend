...
import "../../../School Dashboard/Manage Student/view/manageStudentmainScreen.dart";

class TeacherStudentManageScreen extends StatelessWidget {
  const TeacherStudentManageScreen({super.key});
          ...
          return SizedBox(
            ...
            child: Padding(
              ...
              child: Column(children: [
                GestureDetector(
                  onTap: () => Get.to(() => TeacherStudentInputField(
                        type: "Create student",
                      )),
                  child: Container(
                ...
                GestureDetector(
                  onTap: () => Get.to(
                      () => TeacherStudentSelectClass(type: "Manage Student")),
                  child: Container(
                    height: heightSize(90),
                    width: widthSize(368),
                    padding: EdgeInsets.only(
