...
import 'package:school_management/pages/Teacher%20dashboard/Teacher%20Manage%20Results/views/teacher_select_term.dart';
...
class StudentListForUploadResults extends StatelessWidget {
  StudentListForUploadResults({super.key});
                ...
                child: Padding(
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        teacherController.studentList.isNotEmpty
                            ? SizedBox(
                                height: constraints.maxHeight,
                                width: constraints.maxWidth,
                                child: GridView.builder(
                                    ...
                                    itemCount:
                                        teacherController.studentList.length,
                                    itemBuilder: (context, index) {
                                      return manageStudentResultsView(
                                          teacherController
                                              .studentList.value[index], () {
                                        Get.to(() => TeacherSelectTermScreen(
