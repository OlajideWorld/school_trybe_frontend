...
class TeacherCreateEventsScreen extends StatefulWidget {
  const TeacherCreateEventsScreen({super.key});

  @override
  State<TeacherCreateEventsScreen> createState() =>
      _TeacherCreateEventsScreenState();
}

class _TeacherCreateEventsScreenState extends State<TeacherCreateEventsScreen> {
  ...
  Future pickImage(ImageSource source) async {
    try {
      ...
      setState(() {
        teachController.eventImage = newpicture;
        Get.back();
      });
      return teachController.eventImage;
    ...
    return Scaffold(
      ...
      body: Obx(() {
        return LoadingOverlayPro(
          isLoading: teachController.isloadingEvents.value,
              ...
              child: Column(children: [
                GestureDetector(
                  ...
                  child: SizedBox(
                    ...
                    width: widthSize(368),
                    child: teachController.eventImage != null
                        ? Image.file(
                            teachController.eventImage!,
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            width: widthSize(368),
                            padding:
                                EdgeInsets.symmetric(horizontal: widthSize(23)),
                            decoration: BoxDecoration(
                                color: const Color.fromRGBO(61, 64, 128, 0.05),
                                border: Border.all(color: maincolor),
                                borderRadius:
                ...
                AppButtons(
                    ...
                    onTap: () async {
                      teachController.isloadingEvents.value = true;

                      final response = await teachController.cloudinary.upload(
                        file: teachController.eventImage!.path,
                      ...
                      if (response.isSuccessful) {
                        final model = {
                          "affiliateID":
                              controller2.teachermodel.value.createdBy,
                        ...
                        await ApiCalls().teacherCreateEvents(model);
                        ...
                        await Future.delayed(const Duration(seconds: 1), () {
                          Get.offNamed(TeacherRoutes.homeScreen);
                        });
                      } else {
                        teachController.isloadingEvents.value = false;
                        getErrorSnackBar(
