...
import 'package:school_management/pages/School%20Dashboard/SignIn%20screeen/view/schoolregistrationscreen.dart';
...
class AdminSchoolImageUpload extends StatefulWidget {
  File? image;
  AdminSchoolImageUpload({
    Key? key,
    this.image,
  }) : super(key: key);

  @override
  State<AdminSchoolImageUpload> createState() => _AdminSchoolImageUploadState();
}

class _AdminSchoolImageUploadState extends State<AdminSchoolImageUpload> {
                          ...
                          child: Align(
                            ...
                            child: Column(
                                ...
                                children: [
                                  ...
                                  const CText(
                                    text:
                                        "Kindly upload a picture of your school logo",
                                  ...
                                  AppButtons(
                                      ...
                                      onTap: () async {
                                        ...
                                        if (controller.image!.path.isNotEmpty) {
                                          ...
                                          controller.isLoading.value = false;
                                          getErrorSnackBar(
                                              "Please Provide us with your Profile Pic ");
                                        }
                                      }),
