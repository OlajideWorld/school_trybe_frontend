...
import 'package:school_management/pages/School%20Dashboard/manage_results/view/view_uploaded_results2.dart';
...
import '../../Manage Student/view/manageStudentProfileView.dart';
import '../../Manage Student/widget/manageStudentProfileWidget.dart';

class AdminViewUploadedResults extends StatelessWidget {
  AdminViewUploadedResults({super.key});
            ...
            child: Obx(() {
              return LoadingOverlayPro(
                ...
                child: RefreshIndicator(
                  onRefresh: () => adminController.fetchStudentsProfile(),
                  child: SingleChildScrollView(
                    physics: const AlwaysScrollableScrollPhysics(),
                    child: adminController.studentList.isNotEmpty
                        ? Padding(
                            padding: EdgeInsets.only(
                                top: heightSize(28),
                                left: widthSize(30),
