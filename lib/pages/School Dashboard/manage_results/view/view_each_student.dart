...
class ViewEachStudentResultsScreen extends StatefulWidget {
  final StudentModel model;
  const ViewEachStudentResultsScreen({super.key, required this.model});

  @override
  State<ViewEachStudentResultsScreen> createState() =>
      _ViewEachStudentResultsScreenState();
}

class _ViewEachStudentResultsScreenState
    extends State<ViewEachStudentResultsScreen> {
  ...
  Widget build(BuildContext context) {
    int newUpload = uploadProgress.toInt();
    return Scaffold(
