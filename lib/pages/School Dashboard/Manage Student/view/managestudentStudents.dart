...
import 'package:school_management/pages/School%20Dashboard/Manage%20Student/widget/manageStudentProfileWidget.dart';
import 'package:school_management/utils/colors.dart';

import '../../../../utils/sizes.dart';
import '../../Create Student/view/inputstudentfields.dart';
import '../../home screen/controller/adminController.dart';
import 'manageStudentProfileView.dart';

class ManageStudentsStudentsScreen extends StatelessWidget {
  ManageStudentsStudentsScreen({super.key});
                              ...
                              SizedBox(
                                ...
                                child: GridView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      return manageStudentProfileWidgetView(
                                          controller.studentList.value[index],
                                          () {
                                        Get.to(() =>
                                            ManageStudentProfileViewScreen(
                                                model: controller
