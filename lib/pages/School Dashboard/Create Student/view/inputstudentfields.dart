...
import "../widget/genderSelect.dart";
import "inputstudentfields2.dart";

class InputStudentFIeldsInfo extends StatelessWidget {
  final String type;
  InputStudentFIeldsInfo({super.key, required this.type});
                            ...
                            if (clear!.validate()) {
                              ...
                              if (controller2.image!.path.isEmpty) {
                                ...
                                if (response.isSuccessful) {
                                  ...
                                  Get.to(() => InputStudentInfoScreen2());
                                } else {
                                  controller.isloading.value = false;
