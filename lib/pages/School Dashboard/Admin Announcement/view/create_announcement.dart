...
class AdminCreateAnnouncementPage extends StatefulWidget {
  const AdminCreateAnnouncementPage({super.key});

  @override
  State<AdminCreateAnnouncementPage> createState() =>
      _AdminCreateAnnouncementPageState();
}

class _AdminCreateAnnouncementPageState
    extends State<AdminCreateAnnouncementPage> {
  final AdminAnnounceController announcecontroller =
      AdminAnnounceController.instance;
                ...
                child: Column(children: [
                  GestureDetector(
                    ...
                    child: SizedBox(
                      ...
                      width: widthSize(368),
                      child: announcecontroller.announcementImage != null
                          ? Image.file(
                  ...
                  TextFieldWidgetRegister(
                      ...
                      validator: (String? val) {
                        if (val!.isEmpty) {
                          return "Please enter your Announcement Title";
                        }
                        return null;
                      },
                  ...
                  AppButtons(
                    ...
                    onTap: () async {
                      ...
                      if (announcecontroller.announcementImage!.path.isEmpty ||
                          !clear!.validate()) {
                        announcecontroller.isloading.value = false;
                        getErrorSnackBar(
                            "Please provide an Image for the Announcemnet");
                      } else {
                        announcecontroller.isloading.value = true;
                        final response = await controller2.cloudinary.upload(
                          file: announcecontroller.announcementImage!.path,
